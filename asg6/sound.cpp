  ...
  channels()
{
  ...
  startMusic();
  sounds.push_back( Mix_LoadWAV("sound/bullet.wav") );
  sounds.push_back( Mix_LoadWAV("sound/bird.wav") );
  sounds.push_back( Mix_LoadWAV("sound/orbs.wav") );
  sounds.push_back( Mix_LoadWAV("sound/girl.wav") );
